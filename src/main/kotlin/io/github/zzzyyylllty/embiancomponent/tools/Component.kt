...
class ComponentSetter {
     ...
     */
    fun getAllComponentsJava(item: ItemStack): Map<String, Any?> {
        return asNMSCopy(item).getComponentsJavaNMS()
    }
     ...
     * @return Map.value is Double/Byte/String
     */
    fun getAllComponentsJavaFiltered(item: ItemStack): Map<String, Any?> {
        return asNMSCopy(item).getComponentsJavaNMSFiltered()
    }
